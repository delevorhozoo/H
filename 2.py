            ...
            if response.status_code == 200:
                try:
                    ...
                    if result.get('success') or 'message' in result:
                        ...
                        self.failed_count += 1
                        print(f"{Colors.YELLOW}[!] Response tidak expected: {result}{Colors.END}")
                        return False
                except:
                    # Jika response bukan JSON, anggap success jika status 200
                    self.success_count += 1
                ...
                print(f"{Colors.YELLOW}   Response: {response.text[:100]}...{Colors.END}")
                return False
